...
function Campos() {
  ...
  const dificultad = [
    ...
    { value: 'Dios', label: 'Te lleva a conocer a Dios' }
  ];

  const tipo_ruta = [
    { value: 'Rural', label: 'Rutal' },
      ...
      <div class="card2">
        <form class="form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div class="field">
            ...
            <input type="text" class="input-field" placeholder="Nombre de la Ruta" {...register("nombre")} />
          </div>
          <div class="field">
            <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg" class="input-icon">
              <path d="M12.258 3h-8.51l-.083 2.46h.479c.26-1.544.758-1.783 2.693-1.845l.424-.013v7.827c0 .663-.144.82-1.3.923v.52h4.082v-.52c-1.162-.103-1.306-.26-1.306-.923V3.602l.431.013c1.934.062 2.434.301 2.693 1.846h.479L12.258 3z"/>
            </svg>
            <input type="text" class="input-field" placeholder="Comentarios de la Ruta" {...register("comentario")} />
          </div>
          <div class="field">
            <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg" class="input-icon">
