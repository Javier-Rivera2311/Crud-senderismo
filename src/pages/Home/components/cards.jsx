      ...
      <Card sx={{ ...cardStyle, ...mediaQueryStyle.cardStyle }}>
        <CardContent>
          ...
          <Typography variant="body1">
            ...
            maiores deleniti qui dignissimos, itaque at distinctio repudiandae
            placeat eum temporibus delectus ratione ipsa alias quod ducimus nam?
            At, delectus atque!
          </Typography>
        </CardContent>
      </Card>
      <Card sx={{ ...cardStyle, ...mediaQueryStyle.cardStyle }}>
        <CardContent>
          ...
          <Typography variant="body1">
            ...
            para no perderte. También es importante informar a alguien de tu
            ruta y hora estimada de regreso, por si ocurre algún imprevisto.
          </Typography>
        </CardContent>
      </Card>
    </div>
